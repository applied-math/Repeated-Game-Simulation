...
def main(n_rounds):
    ...
    for n_round in range(1, n_rounds +1):
        ...
        if player1_choice not in ["cooperate", "betray"] or player2_choice not in ["cooperate", "betray"]:
        ...
        print(f"\nResults:")
        print(f"Player 1's choice: {player1_choice}\tPlayer 2's choice: {player2_choice}")
        print(f"Player 1's reward: {player1_reward}\tPlayer 2's reward: {player2_reward}")
